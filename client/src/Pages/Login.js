            ...
            <div className="container auth-form">
                ...
                <form className="login_form_wrapper" onSubmit={handleSubmitLogin}>
                    ...
                    <div className='login_input_wrapper'>
                        ...
                        <input type="email" name="email" placeholder="Enter email" onChange={handleChanges} required />
                    </div>
                    ...
                    {loading ?
                        <button className='wait_btn'>
                            Please wait...
                        </button>
                        :
                        <button className='login_sign_btn'>Մուտք</button>
                    }
                    <p className="bottom-msg-paragraph">եթե գրանցված չեք <Link to="/auth/register">Գրանցվել</Link>!</p>
                </form>
            </div>
        </>
    )
